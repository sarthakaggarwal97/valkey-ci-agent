...
class TestGhcr:
    ...
    def test_hostile_token_body_never_reads_as_public(self, body: bytes) -> None:
        ...
        # "tag exists". Every deviation surfaces as ValueError so the
    ...
    def test_non_object_json_body_is_refused_by_shape_check(self) -> None:
        ...
        # before the shape check existed; must now surface as a clear ValueError.
        with patch("urllib.request.urlopen",
    ...
    def test_ecr_shape_check_applies_uniformly(self) -> None:
        # Same shape-check discipline as ghcr; both are factored through
