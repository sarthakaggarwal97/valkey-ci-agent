...
def test_immutable_ruleset_is_verified_when_github_hides_bypass_actors() -> None:
    repo = MagicMock()
    ...
    assert publish_mod.tag_ruleset_protected(repo, "9.1.2") == publish_mod.TagRulesetVerdict(True, None)
