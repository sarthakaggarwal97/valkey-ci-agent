...
class BackportPRCreator:
    ...
    def create_backport_pr(
        ...
        # adaptation and validation repair also write AI-authored content.
        ai_involved = result.resolved_by_ai or any(
            _was_llm_resolved(r) for r in result.resolutions
        )
